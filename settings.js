...
global.APIs = {
   ...
   alfa1 'https://api.zeeoneofc.my.id',//apabila link api eror, segera laporkan ke owner
}
...
global.APIKeys = {
   ...
   'https://api.zeeoneofc.my.id': 'you key',// 👉 login https://api.zeeoneofc.my.id to get apikey
}
